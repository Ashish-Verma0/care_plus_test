...
import { GETDOCTORLISTBYLIMIT } from "../../common/constants";
...
const Doctors = () => {
  ...
  const getDoctorData = async (page) => {
    const res = await getFetchByLimit(GETDOCTORLISTBYLIMIT, pagination.limit, page);
    return setDoctorData(res?.doctor);
  };
